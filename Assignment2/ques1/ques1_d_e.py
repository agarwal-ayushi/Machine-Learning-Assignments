# # This code contains solutions for Question 1 Part D and E
...
def create_dict(tweets, train_classes):
    ...
    print("Time to Create Dictionary = {:2.3f} sec".format(end-start))
...
def plot_roc(prob4):
    ...
    auc = auc(tpr, fpr)
    print("The AUC score for this classifier model is = {:2.3f} ",format(auc))
